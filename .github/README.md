...
[`@aws-sdk/client-lex-model-building-service`](https://www.npmjs.com/package/@aws-sdk/client-lex-model-building-service/v/3.1115.0).
...
- @aws-sdk/client-lex-model-building-service v3.1115.0 - [https://cloud-sdk-builds.github.io/?sdk=client-lex-model-building-service&version=3.1115.0](https://cloud-sdk-builds.github.io/?sdk=client-lex-model-building-service&version=3.1115.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-model-building-service@3.1115.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b2g4ZSI7lreNdM+MQS6waEEAs+tYOEjFCs2XwvMqeLVfCBMmYsVEXONn0LR+ZYEb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lex-model-building-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-model-building-service@3.1115.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-model-building-service@3.1115.0/index.min.mjs": "sha384-b2g4ZSI7lreNdM+MQS6waEEAs+tYOEjFCs2XwvMqeLVfCBMmYsVEXONn0LR+ZYEb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lex-model-building-service/blob/refs/tags/3.1115.0/LICENSE
```
